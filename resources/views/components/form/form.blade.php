    ...
    <form action="{{ route('register') }}" method="POST">
        ...
        >
            ...
            <div class="flex flex-col gap-5">
                ...
                @if($title == "Register")
                    <button type="button" @click="step = 2" class="bg-violet-900 px-4 py-2 rounded cursor-pointer hover:bg-yellow-200 hover:!text-gray-800">Start Now!</button>
                @else
